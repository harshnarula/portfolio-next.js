...
export default function Contact() {
  ...
  return (
    <>
      {error && (
        <span className={`flex justify-center items-center fixed top-5 right-0 w-auto rounded-sm animate-slideInRight h-[40px] px-[10px] text-white ${
          error === "Sent Successfully" ? 'bg-[#0d6efd]' : 'bg-[red]'
        }`}>
    ...
    <div id = "Contact" className="flex flex-col w-screen h-auto justify-center items-center bg-[#181616]">
      <div className="border-t-2 border-[#0d6efd] w-full h-[2px] m-[10px] animate-slideIn "></div>
      <h6
        ref={ref2}
        className={`w-auto h-auto text-2xl text-[#0d6efd] m-[20px] font-openSans ${
      ...
      <form ref={form} onSubmit={sendEmail} className = 'flex flex-col justify-center items-center'>
        <div className="flex flex-col lg:flex-row w-full justify-center lg:justify-around items-center">
          ...
          >
            <label className="font-openSans w-[60px] lg:w-auto h-auto lg:h-auto text-[#0d6efd] text-sm lg:text-lg mr-[2px] lg:mr-[10px]">
              Name
            </label>
            <input
              type="text"
              ...
              className="font-openSans w-auto h-[20px] lg:h-auto bg-[#181616] hover:border-b-white duration-300 focus:outline-none indent-1 text-white border-b-2 border-[#0d6efd]"
            />
          </div>
          <div
            ref={ref4}
      ...
      >
        <button type = "submit" className="font-openSans w-[120px] h-[40px] bg-[#181616] border-2 rounded-[8px] hover:text-white hover:bg-[#0d6efd] duration-300 border-[#0d6efd] text-[#0d6efd]">
          Send
        </button>
          </div>
