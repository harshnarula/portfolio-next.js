    ...
    <>
      ...
      <div className="hidden lg:flex flex-row justify-center items-start w-screen h-auto py-[10px] ">
        <div className="flex flex-col justify-center items-center m-[5px] animate-scaleUp">
          <CgWebsite className="bg-[#0d6efd] h-[60px] w-[60px] rounded-lg text-white  p-[5px] m-[5px]" />
        ...
        <div className="flex flex-col justify-center items-center m-[5px] animate-scaleUp">
          <FaDatabase className="bg-[#0d6efd] h-[60px] w-[60px] rounded-lg text-white  p-[5px] m-[5px]" />
        ...
        <div className="flex flex-col justify-center items-center m-[5px] animate-scaleUp">
          <SiThealgorithms className="bg-[#0d6efd] h-[60px] w-[60px] rounded-lg text-white  p-[5px] m-[5px]" />
        ...
        <div className="flex flex-col justify-center items-center m-[5px] animate-scaleUp">
          <SiGooglecontaineroptimizedos className="bg-[#0d6efd] h-[60px] w-[60px] rounded-lg text-white  p-[5px] m-[5px]" />
      ...
      <div className="hidden md:flex lg:hidden flex-col justify-center items-center w-screen h-auto py-[10px] ">
        <div className="flex flex-row justify-center items-start">
          <div className="flex flex-col justify-center items-center m-[5px] animate-scaleUp">
            <CgWebsite className="bg-[#0d6efd] h-[40px] w-[40px] rounded-lg text-white  p-[5px] m-[5px]" />
          ...
          <div className="flex flex-col justify-center items-center m-[5px] animate-scaleUp">
            <FaDatabase className="bg-[#0d6efd] h-[40px] w-[40px] rounded-lg text-white  p-[5px] m-[5px]" />
        ...
        <div className="flex flex-row justify-center items-start">
          <div className="flex flex-col justify-center items-center m-[5px] animate-scaleUp">
            <SiThealgorithms className="bg-[#0d6efd] h-[40px] w-[40px] rounded-lg text-white  p-[5px] m-[5px]" />
          ...
          <div className="flex flex-col justify-center items-center m-[5px] animate-scaleUp">
            <SiGooglecontaineroptimizedos className="bg-[#0d6efd] h-[40px] w-[40px] rounded-lg text-white  p-[5px] m-[5px]" />
